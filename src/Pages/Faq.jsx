...
const Faq = () => {
    return (
        <div className=''>
            <div style={{ backgroundImage: "url('https://medicana.co.in/assets/img/slider1.jpg')" }} className="relative w-full h-64 flex items-center justify-center text-center text-white bg-cover bg-center mt-[68px]">
